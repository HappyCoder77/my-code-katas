...
This kata focuses on making a simple docker container for a basic django project. The goal is to mechanize the creation of a basic Docker container.

---

## 🎯 The Objective
Add a Docker container to a basic Django project.
